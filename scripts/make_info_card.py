...
# ===========================================================================
HOST = "dpnsu"   # shown as  dpnsu@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "ML Engineer @ Rechk"),
    ("kv", "Prev", "NIT Warangal · DRDO (ML)"),
    ("kv", "Edu", "B.Tech CSE (AI & ML), UIET MDU"),
    ("kv", "Mail", "deepanshusnpt@gmail.com"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI / ML", "PyTorch, BERT, XGBoost, OpenCV"),
    ("kv", "LLM / RAG", "LangChain, FAISS, HF, Gemini"),
    ("kv", "RAI / Ops", "Fairlearn, SHAP, FastAPI, Docker"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "2 published ML research papers"),
    ("bul", "Responsible-AI audit framework (RBI FREE-AI)"),
    ("bul", "Microsoft Learn Student Ambassador"),
    ("bul", "Top-60 · FHIR Healthcare AI Hackathon"),
]
